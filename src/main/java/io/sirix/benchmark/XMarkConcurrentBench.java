...
public class XMarkConcurrentBench {
  ...
  public static class MyState {
    ...
    public void doSetup() {
      ...
      try (final var wtx = session.beginNodeTrx(); final var fis = new FileInputStream(pathToXmlFile.toFile())) {
      ...
      firstConcurrRtx = session.beginNodeReadOnlyTrx();
      secondConcurrRtx = session.beginNodeReadOnlyTrx();
      thirdConcurrRtx = session.beginNodeReadOnlyTrx();
      firstRtx = session.beginNodeReadOnlyTrx();
      secondRtx = session.beginNodeReadOnlyTrx();
      thirdRtx = session.beginNodeReadOnlyTrx();
    }
